...
export default function App() {
    ...
    {/*SCROLLING:*/}
    {/*Scrollable content: unlike the web, for mobile we need to explicitly tell React Native when areas need to be scrollable. For that purpose we have the ScrollView component*/   }
