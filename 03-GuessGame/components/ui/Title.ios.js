...
//PLATFORM FILES:
//Pay attention to the way this file is named: title.ios.js, this means that when importing this Title component, RN will pick it automatically when the app is open is ios. The same applies for android, we can have another file called: Title.android.js and and the app is open in ios. So this is pretty convenient.
